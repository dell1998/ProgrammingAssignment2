## The functions create a special object that stores a matrix and caches its inverse.
...
The following function computes the inverse of the “matrix” returned by makeCacheMatrix above. If the inverse has 
